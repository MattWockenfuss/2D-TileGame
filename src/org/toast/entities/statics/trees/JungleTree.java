...
public class JungleTree extends StaticEntity{
	...
	public JungleTree(Handler handler, float x, float y) {
		super(handler, x, y, Assets.trees[4].getWidth() * scale, Assets.trees[4].getHeight() * scale);
		//lets scale the tree
		bounds.x = 55 * scale;
		bounds.y = 78 * scale;
		bounds.width = 5 * scale;
	...
	public void render(Graphics g) {
		g.drawImage(Assets.trees[4], (int) (x - handler.getGameCamera().getxOffset()),(int) (y - handler.getGameCamera().getyOffset()),width,height,null);
